...
export async function fetchEmails() {
  ...
  if (error) throw new Error(`Error fetching emails: ${error.message}`);
...
export async function generateEmailContent(email: string, userPrompt: string, websiteContent: string) {
